window.contestOpsData = {
  ...
  runs: [
    ...
    { time: '2026-05-29', name: 'VImport application-fit packet', status: 'done' },
    { time: '2026-05-29', name: 'WAIBAv profile boundary receipt', status: 'done' },
    { time: '2026-05-29', name: 'WAIBAv profile packet receipt', status: 'done' },
  ...
  evidence: [
    ...
    { name: 'Profile app packet', state: 'active', path: 'evidence/public/vimport_profile_application_packet.json' },
    { name: 'Secure input schema', state: 'active', path: 'evidence/public/secure_inputs.public_schema.json' },
    { name: 'Veloclaw policy receipt', state: 'active', path: 'evidence/public/veloclaw_profile_policy_check.txt' },
  ...
  automations: [
    ...
    { name: 'Profile application packet', type: 'VImport', state: 'ready' },
    { name: 'Profile packet receipt', type: 'WAIBAv', state: 'ready' },
